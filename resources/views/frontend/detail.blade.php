                        ...
                        <div class="swiper product-slider-thumbs">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide h-auto swiper-thumb-item mb-3">
                                    <img class="w-100" src="{{ asset('frontend/img/product-detail-1.jpg') }}"
                                        alt="...">
                                </div>
                                <div class="swiper-slide h-auto swiper-thumb-item mb-3">
                                    <img class="w-100" src="{{ asset('frontend/img/product-detail-2.jpg') }}"
                                        alt="...">
                                </div>
                                <div class="swiper-slide h-auto swiper-thumb-item mb-3">
                                    <img class="w-100" src="{{ asset('frontend/img/product-detail-3.jpg') }}"
                                        alt="...">
                                </div>
                                <div class="swiper-slide h-auto swiper-thumb-item mb-3">
                                    <img class="w-100" src="{{ asset('frontend/img/product-detail-4.jpg') }}"
                                        alt="...">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide h-auto">
                                    <a class="glightbox product-view"
                                        href="{{ asset('frontend/img/product-detail-1.jpg') }}" data-gallery="gallery2"
                                ...
                                <div class="swiper-slide h-auto">
                                    <a class="glightbox product-view"
                                        href="{{ asset('frontend/img/product-detail-2.jpg') }}" data-gallery="gallery2"
                                ...
                                <div class="swiper-slide h-auto">
                                    <a class="glightbox product-view"
                                        href="{{ asset('frontend/img/product-detail-3.jpg') }}" data-gallery="gallery2"
                                ...
                                <div class="swiper-slide h-auto">
                                    <a class="glightbox product-view"
                                        href="{{ asset('frontend/img/product-detail-4.jpg') }}" data-gallery="gallery2"
                                        data-glightbox="Product item 4">
                                        <img class="img-fluid"
                                            src="{{ asset('frontend/img/product-detail-4.jpg') }}" alt="...">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="row align-items-stretch mb-4">
                    ...
                    <div class="col-sm-3 pl-sm-0"><a
                            ...
                            href="{{ route('frontend.detail') }}">Add to cart</a></div>
                </div><a class="text-dark p-0 mb-4 d-inline-block" href="#!"><i class="far fa-heart me-2"></i>Add to wish
                    list</a><br>
                <ul class="list-unstyled small d-inline-block">
                    ...
                    <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
                            class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ms-2" href="#!">Demo
                            Products</a></li>
                    <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Tags:</strong><a
                            class="reset-anchor ms-2" href="#!">Innovation</a></li>
                </ul>
            </div>
        </div>
        <!-- DETAILS TABS-->
                        ...
                        <div class="col-lg-8">
                            <div class="d-flex mb-3">
                                <div class="flex-shrink-0"><img class="rounded-circle"
                                        src="{{ asset('frontend/img/customer-1.png') }}" alt="" width="50" /></div>
                                <div class="ms-3 flex-shrink-1">
                                    ...
                                    <p class="text-sm mb-0 text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing
                                        elit,
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0"><img class="rounded-circle"
                                        src="{{ asset('frontend/img/customer-2.png') }}" alt="" width="50" /></div>
                                <div class="ms-3 flex-shrink-1">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="product text-center skel-loader">
                    <div class="d-block mb-3 position-relative"><a class="d-block"
                            href="{{ route('frontend.detail') }}"><img class="img-fluid w-100"
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="product text-center skel-loader">
                    <div class="d-block mb-3 position-relative"><a class="d-block"
                            href="{{ route('frontend.detail') }}"><img class="img-fluid w-100"
                                src="{{ asset('frontend/img/product-2.jpg') }}" alt="..."></a>
                        <div class="product-overlay">
                            <ul class="mb-0 list-inline">
                                <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#!"><i
                                            class="far fa-heart"></i></a></li>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="product text-center skel-loader">
                    <div class="d-block mb-3 position-relative"><a class="d-block"
                            href="{{ route('frontend.detail') }}"><img class="img-fluid w-100"
                                src="{{ asset('frontend/img/product-4.jpg') }}" alt="..."></a>
                        <div class="product-overlay">
                            <ul class="mb-0 list-inline">
                                <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#!"><i
                                            class="far fa-heart"></i></a></li>
