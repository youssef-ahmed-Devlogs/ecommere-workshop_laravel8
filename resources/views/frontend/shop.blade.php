        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold">Electronics</strong>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    <div class="badge text-white bg-"></div><a class="d-block"
                                        href="{{ route('frontend.shop') }}"><img class="img-fluid w-100"
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Kui Ye Chen’s
                                        AirPods</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Air Jordan 12 gym
                                        red</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Cyan cotton
                                        t-shirt</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Timex Unisex
                                        Originals</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Red digital
                                        smartwatch</a></h6>
                                <p class="small text-muted">$250</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Nike air max 95</a>
                                </h6>
                                <p class="small text-muted">$300</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Joemalone Women
                                        prefume</a></h6>
                                <p class="small text-muted">$25</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Apple Watch</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Men silver Byron
                                        Watch</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Ploaroid one step
                                        camera</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    <div class="badge text-white bg-"></div><a class="d-block"
                                        href="{{ route('frontend.shop') }}"><img class="img-fluid w-100"
                                            src="{{ asset('frontend/img/product-11.jpg') }}" alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                                                    href="#!"><i class="far fa-heart"></i></a></li>
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Gray Nike running
                                        shoes</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product text-center">
                                <div class="mb-3 position-relative">
                                    <div class="badge text-white bg-"></div><a class="d-block"
                                        href="{{ route('frontend.shop') }}"><img class="img-fluid w-100"
                                            src="{{ asset('frontend/img/product-12.jpg') }}" alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                                                    href="#!"><i class="far fa-heart"></i></a></li>
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.shop') }}">Black DSLR lense</a>
                                </h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
