                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-lg-end mb-0 px-0 bg-light">
                            <li class="breadcrumb-item">
                                <a class="text-dark" href="{{ route('frontend.index') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a class="text-dark" href="{{ route('frontend.cart') }}">Cart</a>
                            </li>
                ...
                <form action="#">
                    <div class="row gy-3">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <select class="country form-control form-control-lg" id="country"
                ...
                <div class="card border-0 rounded-0 p-lg-4 bg-light">
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="d-flex align-items-center justify-content-between"><strong class="small fw-bold">Red
                                    digital smartwatch</strong><span class="text-muted small">$250</span></li>
