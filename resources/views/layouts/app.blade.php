                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('frontend.detail') }}">Product
                                    detail</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown">
                                    ...
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('frontend.cart') }}">Product detail</a>
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('frontend.detail') }}">Shopping cart</a>
                                    <a class="dropdown-item border-0 transition-link"
                        ...
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('frontend.cart') }}">
                                    ...
                                    Cart <small class="text-gray fw-normal">(2)</small>
                                </a>
                            </li>
                ...
                <div class="modal-body p-0">
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0">
                            ...
                            <a class="glightbox d-none" href="{{ asset('frontend/img/product-5-alt-1.jpg') }}"
                                data-gallery="gallery1" data-glightbox="Red digital smartwatch">
                            </a>
                            <a class="glightbox d-none" href="{{ asset('frontend/img/product-5-alt-2.jpg') }}"
                        ...
                        <div class="col-lg-6">
                            <div class="p-4 my-md-4">
                                ...
                                <p class="text-sm mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing
                                    elit. In ut
                                    ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis
                                    dis
